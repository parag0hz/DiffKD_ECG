#!/bin/bash
# 50Hz trade-off experiments: Lead I student (direct TA500 distillation).
#
# Usage (from ~/sci):
#   DATA_DIR=comper_repo/ptb_xl bash dafd_mvkt/scripts/run_50hz_tradeoff_leadI.sh
#
# Environment variables:
#   DATA_DIR            path to PTB-XL root
#   TEACHER_CKPT        teacher checkpoint
#   TA_CKPT             TA-I-500Hz checkpoint
#   CLECG_ENCODER_CKPT  CLECG encoder checkpoint (Lead I 100Hz)
...
echo "========================================================"
echo "50Hz Trade-off  Lead=I  seed=${SEED}"
echo "TA=${TA_CKPT}"
echo "========================================================"
...
run_student() {
    ...
    local MODEL_NAME="student_I_50hz_${LOSSES_FNAME}${SUFFIX}_seed${SEED}"
...
echo ""
echo "50Hz trade-off Lead I complete."
