#!/bin/bash
# Temporal Segment Feature KD ablation for 50Hz student.
#
# Usage (from ~/sci):
#   DATA_DIR=comper_repo/ptb_xl bash dafd_mvkt/scripts/run_segment_feature_50hz.sh
...
CONFIG="dafd_mvkt/configs/student_50hz_segment.yaml"
HZ=50

echo "========================================================"
echo "Segment Feature KD 50Hz  lead=${LEAD}  seed=${SEED}"
...
echo ""
echo "All Segment Feature KD 50Hz runs complete."
