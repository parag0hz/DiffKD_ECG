#!/bin/bash
# Confidence-Gated Hierarchical KD ablation for 100Hz student.
#
# Usage (from ~/sci):
#   DATA_DIR=comper_repo/ptb_xl bash dafd_mvkt/scripts/run_gated_kd_100hz.sh
#
...
#   GATE_MODE      gating mode        (default: confidence_agreement)
...
echo "========================================================"
echo "Gated KD 100Hz ablation  lead=${LEAD}  seed=${SEED}"
...
# Reference: existing TA-MKD+CRF+Feature (reuses ckpt if present)
run_one "bce"
...
echo ""
echo "All Gated KD 100Hz runs complete."
