#!/bin/bash
# Sequential TA-hier ablation for 50Hz student.
...
#
# Environment variables: same as run_ta_hier_ablation_100hz.sh
...
echo "========================================================"
echo "TA-hier 50Hz ablation  lead=${LEAD}  seed=${SEED}"
...
echo ""
echo "All 50Hz ablation runs complete."
